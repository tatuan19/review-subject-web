...
class DiscussesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discuss" do
    assert_difference('Discuss.count') do
      post discusses_url, params: { discuss: { content: @discuss.content, user_id: @discuss.user_id } }
    end
  ...
  test "should update discuss" do
    patch discuss_url(@discuss), params: { discuss: { content: @discuss.content, user_id: @discuss.user_id } }
